...
void studentu_kategorizacija_1_strategija_testavimas(std::vector<Studentas>&  studentai, const int rodyti_pasirinkimas, const int rusiuoti_pagal, std::chrono::duration<double>& testavimo_laikas, const int i) {
    //ekvivalentu "kietekams" ir "vargsiukams", tiesiog formaliau pavadinta
    std::vector<Studentas> islaike_studentai{};
    std::vector<Studentas> neislaike_studentai{};
    ...
    if(rusiuoti_pagal==3) {
        for(auto &stud :studentai) {
            if(stud.getGalutinisVidurkis() >= 5.0) {
...
void studentu_kategorizacija_2_strategija_testavimas(std::vector<Studentas>&  studentai, const int rodyti_pasirinkimas, const int rusiuoti_pagal, std::chrono::duration<double>& testavimo_laikas, const int i) {
    //ekvivalentu "kietekams" ir "vargsiukams", tiesiog formaliau pavadinta
    std::vector<Studentas> neislaike_studentai{};
    ...
    //Testavimui tik sis variantas, nes jis ir naudojamas testuoti :).
    if (rusiuoti_pagal == 3) {
        while(studentai.back().getGalutinisVidurkis() < 5.0f) {
